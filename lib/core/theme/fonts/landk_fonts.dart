...
TextStyle? h1 = TextStyle(
    fontSize: 34.sp, fontFamily: 'Tajawal', fontWeight: FontWeight.w900);
TextStyle? h2 = TextStyle(
    fontSize: 30.sp, fontFamily: 'Tajawal', fontWeight: FontWeight.w800);
TextStyle? h3 = TextStyle(
    fontSize: 10.sp, fontFamily: 'Tajawal', fontWeight: FontWeight.w700);
